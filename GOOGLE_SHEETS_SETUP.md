...
Create **4 separate sheet tabs** with the following structures:

#### Sheet 1: "Classes"
| className | name    | icon | baseRange | vitality | flavor | cardName | cardCount | cardType | cardDamage | cardFatigue | cardAP | cardDrawCount | cardDesc |
|-----------|---------|------|-----------|----------|--------|----------|-----------|----------|-----------|-------------|--------|-----------|----------|
| WARRIOR   | Warrior | 🛡️  | 1         | 3        | A frontline juggernaut... | Move | 1 | move | 0 | 0 | 0 | 0 | Shift 1 zone |
| WARRIOR   | Warrior | 🛡️  | 1         | 3        | A frontline juggernaut... | Slash | 3 | attack | 2 | 0 | 0 | 0 | Quick swing |
| WARRIOR   | Warrior | 🛡️  | 1         | 3        | A frontline juggernaut... | Heavy Strike | 2 | attack | 4 | 1 | 0 | 0 | +1 Fatigue |

**Key Notes:**
- One row per card in a class deck
- `cardCount` = how many times this card appears in the deck
- Use `cardType`: `move`, `attack`, `draw`, `heal`, `fatigue`, `wound`
